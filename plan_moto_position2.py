...
def make_moto_position2 (grid, i, j, color) :
    try:
        ...
        color = "grey"
        #fummée
        cases [i + 38] [j + 81] ['s'] = life_status
        cases [i + 38] [j + 81] ['c'] = color
        cases [i + 38] [j + 82] ['s'] = life_status
        cases [i + 38] [j + 82] ['c'] = color
        cases [i + 38] [j + 83] ['s'] = life_status
        cases [i + 38] [j + 83] ['c'] = color
        ...
        cases [i + 39] [j + 80] ['s'] = life_status
        cases [i + 39] [j + 80] ['c'] = color
        cases [i + 39] [j + 81] ['s'] = life_status
        cases [i + 39] [j + 81] ['c'] = color
        cases [i + 39] [j + 82] ['s'] = life_status
        cases [i + 39] [j + 82] ['c'] = color
        cases [i + 39] [j + 83] ['s'] = life_status
        cases [i + 39] [j + 83] ['c'] = color
        cases [i + 39] [j + 84] ['s'] = life_status
        cases [i + 39] [j + 84] ['c'] = color
        
        
       
        cases [i + 40] [j + 80] ['s'] = life_status
        cases [i + 40] [j + 80] ['c'] = color
        cases [i + 40] [j + 81] ['s'] = life_status
        cases [i + 40] [j + 81] ['c'] = color
        cases [i + 40] [j + 82] ['s'] = life_status
        cases [i + 40] [j + 82] ['c'] = color
        
        
        cases [i + 41] [j + 80] ['s'] = life_status
        cases [i + 41] [j + 80] ['c'] = color
        cases [i + 41] [j + 81] ['s'] = life_status
        cases [i + 41] [j + 81] ['c'] = color
